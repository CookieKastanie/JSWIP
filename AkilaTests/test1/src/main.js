import { Display, Shader, IndexedVAO, IBO, VBO, Texture } from 'Akila/kgl';
import { Bank, FirstPersonCamera, Matrix4, Parser } from 'Akila/utils';

//const W = 700, H = 580;
const W = window.innerWidth, H = window.innerHeight;
let display;
let mainShader, mainShader2;
let vao, vao2;
let tex;
...
(async () => {
  ...
  const meshs = new Bank("./meshs", ["cube", "dragon", "blue_falcon",], {extension: "obj", default: "cube", treatment: Parser.obj});
