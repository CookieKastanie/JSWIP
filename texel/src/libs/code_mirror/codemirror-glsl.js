module.exports = function(CodeMirror, customFuncNames = '', customAtomNames ='') {
    CodeMirror.defineMode("glsl", function(config, parserConfig) {
      var indentUnit = config.indentUnit,
          ...
          atoms = parserConfig.atoms || words(glslAtoms),
    ...
    if(customFuncNames) glslBuiltins += ' '+ customFuncNames;
    if(customAtomNames) glslAtoms += ' '+ customAtomNames;
